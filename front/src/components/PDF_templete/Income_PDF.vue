      ...
      <div class="container text-box">
        <div class="pdf-page">
          <div class="con-header1">
            ...
            >
              ...
              <div class="text-header">
                ...
                <p>โครงการบริการวิชาการที่มีรายได้จากค่าบริการวิชาการ</p>
          ...
          <div class="con-header-2">
            ...
            <div class="name-list" style="margin: 2rem 1rem 0.5rem 1rem; display: flex">
            ...
            <div v-else>
              <div class="name-list" style="margin: 0 1rem 1rem 1rem">
                <div style="display: flex">
                  ...
                  <h3>
                    {{ projectData.p1.agency_group[0].executive_board_leader_name }}
                  </h3>
                </div>
                <div style="display: flex; margin-top: 1rem">
            ...
            <div class="name-list" style="margin: 0 1rem 1rem 1rem; display: flex">
              <h3 style="width: 890px; margin-right: 2rem">
                ชื่อหัวหน้าคณะบริหารโครงการ &nbsp;&nbsp;&nbsp;
                {{ projectData.p1.project_manager_leader_lists.project_manager_leader || '-'}}
              </h3>
              <h3 style="font-weight: normal">
                ร้อยละการมีส่วนร่วม &nbsp;&nbsp;&nbsp;
                {{
                  projectData.p1.project_manager_leader_lists.percentage_of_participation || '-'
                }}
              </h3>
            </div>
            <div class="name-list" style="margin: 0 1rem 1rem 1rem; display: flex">
              <h3 style="width: 890px; margin-right: 2rem">รายชื่อคณะบริหารโครงการ</h3>
            </div>
            ...
            <div v-if="projectData.p1.project_manager_team_lists.length > 1">
              <div
                ...
                style="margin: 0 1rem 1rem 1rem"
              >
                <div class="name-list" style="margin: 0 1rem 0.5rem 0rem; display: flex; justify-content: space-between;">
                  <h3 style="width: 864px; margin-right: 2rem">
                    &nbsp;&nbsp;{{ index + 1 }}. {{ agency.project_manager_team }}
                  </h3>
                  <h3 style="font-weight: normal">
                    ร้อยละการมีส่วนร่วม &nbsp;&nbsp;&nbsp;
                    {{ agency.percentage_of_participation }}
            ...
            <div v-else>
              <div class="name-list" style="margin: 0 1rem 0.5rem 0rem; display: flex; justify-content: space-between;">
                <h3 style="width: 864px; margin-right: 2rem">
                  &nbsp;&nbsp;1.
                  {{ projectData.p1.project_manager_team_lists[0].project_manager_team || '-'}}
                </h3>
                <h3 style="font-weight: normal">
                  ร้อยละการมีส่วนร่วม &nbsp;&nbsp;&nbsp;
                  {{
                    projectData.p1.project_manager_team_lists[0]
        ...
        <div class="pdf-page">
          <div class="con-header-3">
            ...
            <div class="text-con" style="margin: 1rem 0 1rem 0">
              <h3 style="margin: 2rem 1rem 2rem 1rem; font-weight: bold">
              ...
              <div
                v-if="
                  Object.values(projectData.p2.project_type || {}).filter(
                    (type) => type.checked
                  ).length > 1
                "
              >
              ...
              <div
                v-if="
                  Object.values(projectData.p2.academicServiceIssues || {}).filter(
                    (type) => type.checked
                  ).length > 1
                "
              >
                <div
                  v-for="(item, index) in Object.values(
                    projectData.p2.academicServiceIssues || {}
                  ).filter((type) => type.checked)"
                  :key="index"
                  class="name-list"
                  style="margin: 0 1rem 0.5rem 1rem; display: flex"
              ...
              <h3 style="margin: 2rem 1rem 2rem 1rem; font-weight: bold">
                ความสอดคล้องกับเป้าหมายการพัฒนาที่ยั่งยืน (Sustainable Development Goals:
                SDGs)
              </h3>
              <!-- กรณีมีมากกว่า 1 รายการ -->
              <div v-if="projectData.p2.sdgs.filter((item) => item.is_check).length > 1">
                <div
                  v-for="(item, index) in projectData.p2.sdgs.filter(
                    (item) => item.is_check
                  )"
                  :key="item.id"
                  class="name-list"
        ...
        <div class="pdf-page">
          <div class="con-header-4">
            ...
            <div class="text-con">
              <h3 style="margin: 1rem 1rem 5rem 2.1rem; font-weight: normal">
          ...
          <div class="con-header-5">
            ...
            <div class="text-con">
              ...
              <!-- กรณีมีแค่ 1 หน่วยงาน -->
              <div v-else>
                <div class="name-list" style="margin: 0 1rem 0.5rem 1rem; display: flex">
                  <h3 style="width: 1260px">
                    &nbsp;&nbsp;1. {{ projectData.p3.projectObjectives[0].value }}
                  </h3>
                </div>
              </div>
            </div>
          ...
          <div class="con-header-6">
            ...
            <div class="text-con" style="margin: 1rem">
              <table
                cellspacing="0"
                cellpadding="20"
                style="border: 4px solid black; width: 100%; table-layout: fixed"
              >
                <thead style="text-align: center">
                  ...
                  <tr>
                    ...
                    <th style="background-color: #fbc16a; border-right: 4px solid black">
                      Change
                    </th>
                  </tr>
                </thead>
        ...
        <div class="pdf-page">
          <div class="con-header-7">
            ...
            <div class="text-con">
              <h3 style="margin: 0 1rem 2rem 2.1rem; font-weight: normal">
                {{ projectData.p3.toc }}
              </h3>
            </div>
          </div>
          <div class="con-header-8">
            ...
            <div class="text-con">
              <h3
                ...
                "
              >
                &nbsp;&nbsp;<b>สถานที่จัดโครงการ</b> &nbsp;&nbsp;&nbsp;
                {{ projectData.p4.location }}
              </h3>
              <h3 style="margin: 0 1rem 2rem 1rem; font-size: 24px; font-weight: bold">
                &nbsp;&nbsp;วันดำเนินโครงการ
              </h3>
              <div class="place-con">
                <div class="place-list" style="margin: 0 1rem 1rem 1rem; display: flex">
                  &nbsp;
                  <h3
                    style="
                      width: 500px;
                ...
                <div class="place-list" style="margin: 0 1rem 1rem 1rem; display: flex">
                  ...
                  <div
                    v-if="
                      projectData.p4?.multipleSessions?.length == 1 &&
                      projectData.p4.multipleSessions[0].location &&
                      projectData.p4.multipleSessions[0].date
                    "
                    class="name-list"
                    style="margin: 0 1rem 0.5rem 1rem; display: flex"
                  >
        ...
        <div class="pdf-page">
          <div class="con-header-9">
            ...
            <div class="text-con">
              <h3 style="margin: 2rem 1rem 0.5rem 1rem; font-weight: bold">
                &nbsp;&nbsp;ประเภทของกลุ่มเป้าหมาย
              </h3>
              <!-- กรณีมีมากกว่า 1 หน่วยงาน -->
              <div
                v-if="
                  Object.values(projectData.p4.targetGroups || {}).filter(
                    (type) => type.checked
                  ).length > 1
                "
              >
              ...
              <h3
                style="margin: 2rem 1rem 2rem 1rem; font-size: 24px; font-weight: normal"
              >
                <b>&nbsp;&nbsp;พื้นที่ของกลุ่มเป้าหมาย :</b> &nbsp;&nbsp;&nbsp;{{
                  projectData.p4.targetArea
                }}
              </h3>
              <!-- <h3
                style="
          ...
          <div class="con-header-10">
            ...
            <div class="text-con" style="margin: 1rem 0 1rem 0">
              ...
              <div
                v-if="
                  Object.values(projectData.p5.assessmentMethods || {}).filter(
                    (type) => type.checked
                  ).length > 1
                "
              >
                <div
                  v-for="(item, index) in Object.values(
                    projectData.p5.assessmentMethods || {}
                  ).filter((type) => type.checked)"
                  :key="index"
                  class="name-list"
                  style="margin: 0 1rem 0.5rem 1rem; display: flex"
              ...
              <div
                v-if="
                  Object.values(projectData.p5.followUpMethods || {}).filter(
                    (type) => type.checked
                  ).length > 1
                "
              >
                <div
                  v-for="(item, index) in Object.values(
                    projectData.p5.followUpMethods || {}
                  ).filter((type) => type.checked)"
                  :key="index"
                  class="name-list"
                  style="margin: 0 1rem 0.5rem 1rem; display: flex"
              ...
              <div class="place-list" style="margin: 0 1rem 1rem 1rem; display: flex">
                ...
                >
                  ระยะเวลาเริ่มต้น : &nbsp;&nbsp;&nbsp;
                  {{ projectData.p5.followUpDuration.startDate }}
                </h3>
                <h3 style="font-weight: normal; font-size: 20px">
                  ระยะเวลาสิ้นสุด : &nbsp;&nbsp;&nbsp;
                  {{ projectData.p5.followUpDuration.endDate }}
                </h3>
              </div>
            </div>
          </div>
        ...
        <div class="pdf-page">
          <div class="con-header-12">
            ...
            <div class="registration-fee-con">
              <div
              ...
              <div
                v-if="
                  projectData.p7 &&
                  projectData.p7.rows &&
                  Array.isArray(projectData.p7.rows) &&
                  projectData.p7.rows.length > 1
                "
              >
                <div
                  v-for="(agency, index) in projectData.p7.rows"
                  :key="index"
                  class="name-list"
                  style="margin: 0 1rem 1rem 0"
                >
                  ...
                  >
                    <h4 style="font-weight: normal; font-size: 27px;">
                      &nbsp;{{ index + 1 }}. ประเภทอัตรา รายละเอียดคำนวณ
                      <b>{{
                        agency.rate != null && agency.people != null
                          ? (agency.rate * agency.people).toLocaleString()
                          : "-"
                      }}</b>
                      คือประเภท <b>{{ agency.type || "-" }}</b> อัตรา
                      <b>{{ agency.rate ? agency.rate.toLocaleString() : "-" }}</b> (บาท)
                      จำนวน
                      <b>{{ agency.people ? agency.people.toLocaleString() : "-" }}</b>
                      (คน)
                    </h4>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <h4 style="font-weight: normal; font-size: 27px;">
                    &nbsp;1. ประเภทอัตรา รายละเอียดคำนวณ
                    <b>{{
                      projectData.p7.rows[0].rate != null &&
                      projectData.p7.rows[0].people != null
                        ? (
                            projectData.p7.rows[0].rate * projectData.p7.rows[0].people
                          ).toLocaleString()
                        : "-"
                    }}</b>
                    คือประเภท <b>{{ projectData.p7.rows[0].type || "-" }}</b> อัตรา
                    <b>{{
                      projectData.p7.rows[0].rate
                        ? projectData.p7.rows[0].rate.toLocaleString()
                        : "-"
                    }}</b>
                    (บาท) จำนวน
                    <b>{{
                      projectData.p7.rows[0].people
                        ? projectData.p7.rows[0].people.toLocaleString()
                        : "-"
                    }}</b>
                    (คน)
                  </h4>
              ...
              <div v-else>
                ...
                >
                  <h4 style="font-weight: normal; font-size: 27px;">
                    1. ประเภทอัตรา รายละเอียดคำนวณ <b>-</b> คือประเภท <b>-</b> อัตรา
                    <b>-</b> (บาท) จำนวน <b>-</b> (คน)
                  </h4>
                </div>
              </div>
              ...
              >
                <h2 style="font-weight: bold">
                  ...
                  บาท รวมจำนวนกลุ่มเป้าหมาย
                  {{
                    projectData.p7 &&
                    projectData.p7.rows &&
                    Array.isArray(projectData.p7.rows)
                      ? projectData.p7.rows
                          .reduce((total, row) => total + (Number(row?.people) || 0), 0)
                          .toLocaleString()
                      : "-"
                  }}
                  คน
            ...
            <div class="support-fee-con">
              ...
              <div
                v-if="
                  projectData.p7 &&
                  projectData.p7.conditions &&
                  Array.isArray(projectData.p7.conditions) &&
                  projectData.p7.conditions.length > 1
                "
              >
                <div
                  v-for="(agency, index) in projectData.p7.conditions"
                  :key="index"
                  class="name-list"
                  style="margin: 0 1rem 1rem 0"
                >
                  <div class="support-fee-list" style="margin: 2rem 1rem 0 2rem">
                    <h3 style="font-weight: normal; margin-bottom: 1rem">
                      &nbsp;{{ index + 1 }}. อัตรา
                      {{ agency.amount ? agency.amount.toLocaleString() : "-" }} (บาท)
                      จำนวน
                      {{ agency.units ? agency.units.toLocaleString() : "-" }} (หน่วยงาน)
                      รวมจำนวนเงิน
                      {{
                        agency.amount != null && agency.units != null
                          ? (agency.amount * agency.units).toLocaleString()
                          : "-"
                      }}
                      (บาท)
                    </h3>
                    <h3 style="font-weight: bold; margin-left: 2rem">
                      เกณฑ์ข้อกำหนด/เงื่อนไข
                    </h3>
                    <h3 style="font-weight: normal; margin: 0 0 1rem 3rem">
                      {{ agency.condition || "-" }}
                    </h3>
                  </div>
                </div>
              ...
              >
                <div class="support-fee-list" style="margin: 0 1rem 0 2rem">
                  <h3 style="font-weight: normal; margin-bottom: 1rem">
                    &nbsp;1. อัตรา
                    {{
                      projectData.p7.conditions[0].amount
                        ? projectData.p7.conditions[0].amount.toLocaleString()
                        : "-"
                    }}
                    (บาท) จำนวน
                    {{
                      projectData.p7.conditions[0].units
                        ? projectData.p7.conditions[0].units.toLocaleString()
                        : "-"
                    }}
                    (หน่วยงาน) รวมจำนวนเงิน
                    {{
                      projectData.p7.conditions[0].amount != null &&
                      projectData.p7.conditions[0].units != null
                        ? (
                            projectData.p7.conditions[0].amount *
                            projectData.p7.conditions[0].units
                          ).toLocaleString()
                  ...
                  <h3 style="font-weight: normal; margin: 0 0 1rem 3rem">
                    {{ projectData.p7.conditions[0].condition || "-" }}
                  </h3>
                </div>
              </div>
              ...
              <div v-else>
                <div class="support-fee-list" style="margin: 0 1rem 0 2rem">
                  <h3 style="font-weight: normal; margin-bottom: 1rem">
                    1. อัตรา - (บาท) จำนวน - (หน่วยงาน) รวมจำนวนเงิน - (บาท)
                  </h3>
                  <h3 style="font-weight: bold; margin-left: 2rem">
                    เกณฑ์ข้อกำหนด / เงื่อนไข
                  </h3>
            ...
            <div class="total-list-con">
              ...
              >
                ...
                <h3 style="font-weight: normal; width: 400px">
                  {{
                    projectData.p7?.totalIncome
                      ? Number(projectData.p7.totalIncome).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                      : "-"
              ...
              >
                ...
                <h3 style="font-weight: normal; width: 400px">
                  {{
                    projectData.p6?.total
                      ? Number(projectData.p6.total).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                      : "-"
              ...
              >
                ...
                <h3 style="font-weight: normal; width: 400px">
                  {{
                    projectData.p7?.CommonFee
                      ? Number(projectData.p7.CommonFee).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                      : "-"
              ...
              <div class="total-list" style="margin: 2rem 1rem 0 2rem">
                <div class="d-flex">
                  ...
                  <h3 style="font-weight: normal; width: 400px">
                    {{
                      projectData.p6?.total && projectData.p7?.CommonFee
                        ? (
                            (Number(projectData.p6.total) || 0) +
                            (Number(projectData.p7.CommonFee) || 0)
                          ).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
              ...
              <div class="total-list" style="margin: 2rem 1rem 0 2rem">
                <div class="d-flex">
                  <h3 style="font-weight: normal; width: 500px">
                    รวมรายได้หลังหักค่าใช้จ่าย
                  </h3>
                  <h3 style="font-weight: normal; width: 400px">
                    {{
                      projectData.p7?.netIncomeAfterCost
                        ? Number(projectData.p7.netIncomeAfterCost).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                        : "-"
              ...
              <div class="total-list" style="margin: 2rem 1rem 0 2rem">
                <div style="display: flex">
                  ...
                  <h3 style="font-weight: bold; width: 400px">
                    {{
                      projectData.p7?.breakEvenPoint
                        ? Number(projectData.p7.breakEvenPoint).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                        : "-"
                ...
                <h3 style="font-weight: bold">
                  ร้อยละของกำไรสุทธิ (Net Profit Margin)
                  {{
                    projectData.p7?.netProfitPercent
                      ? Number(projectData.p7.netProfitPercent).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                      : "-"
            ...
            <div class="compensation-con">
              ...
              >
                <h3 style="font-weight: bold">
                  การจัดสรรค่าตอบแทนในกรณีที่ปรากฏมีรายได้เหนือค่าใช้จ่าย
                </h3>
              </div>
              ...
              >
                <thead
                  style="border-top: 4px solid #6f78a1; border-bottom: 4px solid #6f78a1"
                >
                  <tr>
                ...
                <tbody style="background-color: #e3e3e3">
                  <tr>
                    <td style="font-weight: bold">
                      {{
                        projectData.p7?.universityIncome
                          ? Number(projectData.p7.universityIncome).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                          : "-"
                    ...
                    <td style="font-weight: bold">
                      {{
                        projectData.p7?.facultyManageShare
                          ? Number(projectData.p7.facultyManageShare).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })
                          : "-"
...
const tableRows = computed(() => {
  ...
  const output1 = outputData?.[0]?.value?.trim()
    ? `2.3 ${outputData[0].value.trim()}`
    : "-";
  const output2 = outputData?.[1]?.value?.trim()
    ? `2.4 ${outputData[1].value.trim()}`
    : "-";
  ...
  const staticRows = [
    {
      ...
      outcomeUser:
        "3.1 User ผู้ใช้ประโยชน์จากผลผลิตของงานบริการวิชาการ งานบริการวิชาการที่เกิดผลลัพธ์ที่สำคัญต้องมีผู้ใช้ประโยชน์ (User) มีการยอมรับหรือการนำไปใช้ในหลายระดับ",
      outcomeChange:
        "3.2 Change การเปลี่ยนแปลงที่เกิดขึ้นพิจารณาการใช้ประโยชน์ผลผลิต (Output) แยกตามผู้ใช้ (User) แต่ละประเภท ซึ่งการเปลี่ยนแปลงอาจเกิดขึ้นต่างช่วงเวลากัน",
    ...
    },
    {
      ...
      outcomeUser:
        userQueue.length > 0
          ? `3.1.${staticOutcomeUserMinor++} ${userQueue.shift().trim()}`
          : "-",
      outcomeChange:
        changeQueue.length > 0
          ? `3.2.${staticOutcomeChangeMinor++} ${changeQueue.shift().trim()}`
          : "-",
      impact: impactQueue.shift() || "-",
    },
    {
  ...
  while (
    ...
    const outputText = rawOutput?.trim()
      ? `2.${outputCounter++} ${rawOutput.trim()}`
      : "-";
