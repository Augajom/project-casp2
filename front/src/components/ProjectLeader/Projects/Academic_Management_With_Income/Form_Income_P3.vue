        ...
        <div class="row p-4">
          ...
          <div class="mb-3 mt-0">
            ...
            <div class="mb-1 mt-0">
              ...
              <div class="mt-3 mb-1 d-flex justify-content-center">
                <textarea type="text" class="form-control beautiful-box" v-model="Project_Data_P3.toc" style="max-width: 100%; min-width: 100%; height: 15px; "
          ...
          <div class="row">
            <div class="col-6 d-flex justify-content-end">
              <router-link :to="{path:'/pl/in_come/p_2',query:{project_id: project_id || '',project_type:2}}">
...
const autoSave = debounce(async () => {
  try {
    ...
    const response = await axios.post('http://localhost:5000/pl/p_3/income/save', { 
    project_id: project_id.value, 
    project_type: project_type.value,
    project_user: user_id.value,
    ...
    if(response.data.success){
      ...
      router.replace({path:'/pl/in_come/p_4',query:{project_id: project_id.value || '', project_type:2}})
       Toast.fire({
                    icon: 'success',
                    iconColor: 'green',
