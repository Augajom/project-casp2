<template>
  <div>
    <NavbarProject
      class="fixed-top"
      propText="โครงการบริการวิชาการที่มีรายได้"
    />
    <ProgressBar
        ...
        >
          ...
          <div>
            <div
              ...
              v-for="(row, index) in Project_Data_P7.rows"
              :key="index"
            >
              <div class="col">
                <input
            ...
            <div
              ...
              v-if="Project_Data_P7.rows.length > 1"
            >
              <button
                class="btn btn-danger"
                @click="removeRow(Project_Data_P7.rows.length - 1)"
              >
                ลบแถวล่าสุด
              </button>
            </div>
            <div class="text-center mb-4">
              <button
                ...
                @click="addRow"
                :disabled="Project_Data_P7.rows.length >= 10"
              >
          ...
          <div
            v-for="(item, index) in Project_Data_P7.conditions"
            :key="index"
            class="mb-4 mt-0"
          >
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  class="form-control"
                  :value="
                    Number(Project_Data_P7.totalIncome || 0).toLocaleString(
                      'en-US',
                      {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  :value="
                    Number(Project_Data_P7.totalCost || 0).toLocaleString(
                      'en-US',
                      {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  :value="
                    Number(Project_Data_P7.CommonFee || 0).toLocaleString(
                      'en-US',
                      {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  :value="
                    Number(
                      Project_Data_P7.totalCostSummary || 0
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  :value="
                    Number(
                      Project_Data_P7.netIncomeAfterCost || 0
                    ).toLocaleString('en-US', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  :value="
                    (
                      Math.floor(
                        Number(Project_Data_P7.breakEvenPoint || 0) * 100
                      ) / 100
                    ).toLocaleString('en-US', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  :value="
                    Number(Project_Data_P7.costPerPerson || 0).toLocaleString(
                      'en-US',
                      {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
            ...
            <div class="row mb-2 align-items-center">
              ...
              <div class="col-4" style="margin-left: 100px">
                <input
                  ...
                  :value="Project_Data_P7.netProfitPercent"
                  readonly
                />
              </div>
            </div>
              ...
              <div class="row mb-2 align-items-center">
                ...
                <div class="col-4" style="margin-left: 100px">
                  <input
                    ...
                    :value="
                      Number(
                        Project_Data_P7.universityIncome || 0
                      ).toLocaleString('en-US', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })
              ...
              <div class="row mb-2 align-items-center">
                ...
                <div class="col-4" style="margin-left: 100px">
                  <input
                    ...
                    :value="
                      Number(
                        Project_Data_P7.facultyUnitShare || 0
                      ).toLocaleString('en-US', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })
              ...
              <div class="row mb-2 align-items-center">
                ...
                <div class="col-4" style="margin-left: 100px">
                  <input
                    ...
                    :value="
                      Number(
                        Project_Data_P7.facultyManageShare || 0
                      ).toLocaleString('en-US', {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })
          ...
          <div class="mb-3 mt-2 text-center">
            <div class="row">
              <p class="text-center text-white">แนบไฟล์กำหนดการโครงการ</p>
            </div>
            ...
            >
              ...
              <div
                class="d-flex justify-content-center align-items-center flex-wrap mb-2"
              >
                <label
                  for="file-upload"
              ...
              <p class="text-warning text-center">
                ...
                .xlsx) และ ขนาดไม่เกิน 10 MB.
              </p>

              <!-- แสดงชื่อไฟล์ที่เคยอัปโหลด -->
              <div
              ...
              >
                <p
                  ...
                  style="max-width: 700px; word-break: break-word"
                >
                  ไฟล์เดิม :
                  <a
...
const totalBudget = computed(() => {
  return Project_Data_P7.rows.reduce(
...
const totalPeople = computed(() => {
  return Project_Data_P7.rows.reduce((sum, row) => sum + Number(row.people), 0);
});

// ฟังก์ชันเพิ่มแถว
function addRow() {
  if (Project_Data_P7.rows.length < 10) {
    Project_Data_P7.rows.push({ type: "", rate: "", people: "" });
  }
}

// ฟังก์ชันลบแถวล่าสุด
function removeRow(index) {
  if (Project_Data_P7.rows.length > 1) {
    Project_Data_P7.rows.splice(index, 1);
  }
}

function addConditionSet() {
  Project_Data_P7.conditions.push({
    condition: "",
    amount: 0,
    units: 0,
  });
...
function removeConditionSet(index) {
  if (Project_Data_P7.conditions.length > 1) {
    Project_Data_P7.conditions.splice(index, 1);
  }
}

//รวมรายได้ (บาท)
const totalIncome = computed(() => {
  const totalFromRows = Project_Data_P7.rows.reduce((sum, row) => {
    return sum + Number(row.rate) * Number(row.people);
  }, 0);

  const totalFromConditions = Project_Data_P7.conditions.reduce((sum, cond) => {
...
//ต้องคูณแต่ละค่าลงทะเบียน
watchEffect(() => {
  const income = totalIncome.value;
  Project_Data_P7.totalIncome = income.toFixed(2);

  if (income <= 1000000) {
    Project_Data_P7.CommonFee = (income * 0.1).toFixed(2);
  } else if (income <= 3000000) {
    Project_Data_P7.CommonFee = (income * 0.15).toFixed(2);
  } else {
    Project_Data_P7.CommonFee = (income * 0.2).toFixed(2);
  }
});

//vc ค่าส่วนกลาง
const rowsWithVC = computed(() => {
  return Project_Data_P7.rows.map((row) => {
...
watch(rowsWithVC, (newVal) => {}, { immediate: true });

//vc แต่ละ ค่าลง
const rowsWithAddedVC = computed(() => {
  const Vc = parseFloat(Project_Data_P7.Vc) || 0;
...
const rowsWithPeoplePercent = computed(() => {
  const totalPeople = Project_Data_P7.rows.reduce((sum, row) => {
...
//จุดคุ้มทุน
watchEffect(() => {
  const Fc = parseFloat(Project_Data_P7.Fc) || 0;
  const total = rowsFinalCalculation.value.reduce((sum, row) => {
    return sum + parseFloat(row.finalValue || 0);
  }, 0);

  const ratio = total !== 0 ? Fc / total : 0;
  Project_Data_P7.breakEvenPoint = ratio; // บันทึก breakevenPoint

});

// const breakpoint = computed(() => {
//   const Fc = parseFloat(Project_Data_P7.Fc) || 0;
//   const total = parseFloat(totalFinalValue.value) || 1;
//   const bp = (Fc / total).toFixed(2);
//   return bp;
// });
...
const handleFileChange = (event) => {
  ...
  Project_Data_P7.file = validFiles.length > 0 ? validFiles[0] : null; // อย่าลืมเปลี่ยนชื่อให้ตรงกับ data ที่เก็บ ในที่นี้คือ Project_Data_P7
...
const submitFile = async () => {
  ...
  try {
    ...
    if (response.data.success) {
      ...
      Project_Data_P7.fileName = response.data.file.filename;
    } else {
...
const fetchExistingFile = async () => {
  try {
    ...
    if (existingFileName.value) {
      Project_Data_P7.file = { name: existingFileName.value };
    }
  } catch (err) {
...
const getDataWhenProjectID = async () => {
  try {
    ...
    //console.log("data7", project_data_7)

    if (project_data_6 != null || project_data_7 != null) {
      Project_Data_P7.totalCost = project_data_6.total;
      Project_Data_P7.Fc = project_data_6.totalFc;
      Project_Data_P7.Vc = project_data_6.totalVc;
      Project_Data_P7.rows = project_data_7.rows;
      Project_Data_P7.conditions = project_data_7.conditions;
      Project_Data_P7.totalIncome = project_data_7.totalIncome;
      Project_Data_P7.CommonFee = project_data_7.CommonFee;
      Project_Data_P7.totalCostSummary = project_data_7.totalCostSummary;
      Project_Data_P7.netIncomeAfterCost = project_data_7.netIncomeAfterCost;
      Project_Data_P7.breakEvenPoint = project_data_7.breakEvenPoint;
      Project_Data_P7.costPerPerson = project_data_7.costPerPerson;
      Project_Data_P7.netProfitPercent = project_data_7.netProfitPercent;
      Project_Data_P7.universityIncome = project_data_7.universityIncome;
      // Project_Data_P7.projectAdminFund = project_data_7.projectAdminFund;
      Project_Data_P7.facultyManageShare = project_data_7.facultyManageShare;
...
watch(
  Project_Data_P7,
  (newVal) => {
    //console.log('--- Validating Project_Data_P7 ---');
    let valid = true;
...
const formattedtotalCost = computed(() => {
  const cost = Number(Project_Data_P7.totalCost);
  if (!isNaN(cost)) {
...
watchEffect(() => {
  const cost = Number(Project_Data_P7.totalCost);
  const fee = Number(Project_Data_P7.CommonFee);
  const total = cost + fee;

  Project_Data_P7.totalCostSummary = !isNaN(total) ? total.toFixed(2) : "0.00";
});
//รวมรายได้ (บาท)หลังหักค่าใช้จ่าย
watchEffect(() => {
  const income = Number(Project_Data_P7.totalIncome);
  const cost = Number(Project_Data_P7.totalCost);
  const fee = Number(Project_Data_P7.CommonFee);

  const totalCostSummary = cost + fee;
  Project_Data_P7.totalCostSummary = !isNaN(totalCostSummary)
    ? totalCostSummary.toFixed(2)
    : "0.00";

  const net = income - totalCostSummary;
  Project_Data_P7.netIncomeAfterCost = !isNaN(net) ? net.toFixed(2) : "0.00";
});
...
watchEffect(() => {
  ...
  Project_Data_P7.costPerPerson = !isNaN(costPerPerson)
...
watchEffect(() => {
  ...
  Project_Data_P7.universityIncome = !isNaN(universityIncome)
    ? universityIncome.toFixed(2)
    : "0.00";

  const netProfitPercent = income > 0 ? (universityIncome / income) * 100 : 0;

  Project_Data_P7.netProfitPercent = !isNaN(netProfitPercent)
    ? netProfitPercent.toFixed(2)
    : "0.00";

  const facultyShare = net * 0.25;
  Project_Data_P7.facultyUnitShare = !isNaN(facultyShare)
    ? facultyShare.toFixed(2)
    : "0.00";

  const facultyManageShare = net * 0.25;
  Project_Data_P7.facultyManageShare = !isNaN(facultyManageShare)
...
const autoSave = debounce(async () => {
  try {
    const response = await axios.post(
      "https://asds-cas.mfu.ac.th/api/pl/p_7/income/save",
      {
        project_id: project_id.value,
        project_type: project_type.value,
        project_user: user_id.value,
...
const pdfPreview = computed(() => {
  if (project_type.value === "2" || project_type.value === 2) {
    return {
      path: "/in-come/pdf",
      query: {
        project_id: project_id.value || "",
