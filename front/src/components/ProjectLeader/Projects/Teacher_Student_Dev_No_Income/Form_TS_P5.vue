      ...
      <div class="d-flex justify-content-center">
        ...
        >
          <div class="row text-white fs-3 mt-3">
            <p>ส่วนที่ 5 การประเมินผลและการติดตามผล</p>
          </div>
          <div class="p-2">
            <div class="row">
              ...
              <div class="container mt-1 p-3">
                <div class="row mb-2">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      ...
                      v-model="Project_Data_P5.assessmentMethods.prePostTest.checked"
                      type="checkbox"
                    />
                  </div>
                  <div class="col-11">
                ...
                <div class="row mb-2">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      class="form-check-input circle-input"
                      v-model="Project_Data_P5.assessmentMethods.projectEvaluation.checked"
                      type="checkbox"
                    />
                  </div>
                  <div class="col-11">
                ...
                <div class="row mb-2">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      class="form-check-input circle-input"
                      v-model="Project_Data_P5.assessmentMethods.observation.checked"
                      type="checkbox"
                    />
                  </div>
                  <div class="col-11">
                ...
                <div class="row">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      class="form-check-input circle-input"
                      v-model="Project_Data_P5.assessmentMethods.others.checked"
                      type="checkbox"
                    />
                  </div>
                  <div class="col-11">
                ...
                <div class="ms-4">
                  <input
                  type="text "
                  v-if="Project_Data_P5.assessmentMethods.others.checked"
                  v-model="Project_Data_P5.assessmentMethods.others.value"
              ...
              <div class="container mt-1 p-3">
                <div class="row mb-2">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      class="form-check-input circle-input"
                      v-model="Project_Data_P5.followUpMethods.followUpObservation.checked"
                      type="checkbox"
                    />
                  </div>
                  <div class="col-11">
                ...
                <div class="row mb-2">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      class="form-check-input circle-input"
                      v-model="Project_Data_P5.followUpMethods.followUpPerformance.checked"
                      type="checkbox"
                    />
                  </div>
                  <div class="col-11">
                ...
                <div class="row mb-2">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      class="form-check-input circle-input"
                      v-model="Project_Data_P5.followUpMethods.otherDetails.checked"
                      type="checkbox"
                    />
                  </div>
                  <div class="col-11">
                ...
                <div class="ms-4">
                  <input
                  type="text "
                  v-if="Project_Data_P5.followUpMethods.otherDetails.checked"
                  v-model="Project_Data_P5.followUpMethods.otherDetails.value"
                  class="form-control mt-3 beautiful-box"
                  placeholder="โปรดระบุเพิ่มเติม"
                />
                </div>
                  ...
                  <div class="d-flex flex-column">
                    <div>
                      ...
                      <div class="mt-2">
                        <input
                          type="date"
                          v-model="Project_Data_P5.followUpDuration.startDate"
                  ...
                  <div class="d-flex flex-column">
                    <div>
                      ...
                      <div class="d-flex mt-2">
                        <input
                          type="date"
                          v-model="Project_Data_P5.followUpDuration.endDate"
                          class="form-control text-center fw-light text-muted beautiful-box"
                          name=""
                          id=""
                        />
              ...
              <div class="container mt-1 p-3">
                <div class="row mb-2">
                  <div class="col-1 d-flex justify-content-center">
                    <input
                      class="form-check-input circle-input"
                      v-model="Project_Data_P5.projectImpact.description"
                      type="radio"
                      name="target"
                      value="report"
                    />
                ...
                <div class="row mb-2">
                  ...
                  <div
                    class="mt-2"
                    v-if="Project_Data_P5.projectImpact.description === 'committee'"
                  >
                    <div>
                ...
                <div class="row mb-2">
                  ...
                  <div
                    class="mt-2"
                    v-if="Project_Data_P5.projectImpact.description === 'externalData'"
                  >
                    <div>
                      <p class="text-warning" style="margin: 0.7rem 0 0 5.5rem;">
                          สามารถแนบไฟล์ Word (.doc, .docx), PDF (.pdf), Excel (.xls, .xlsx) และขนาดไม่เกิน 10 MB.
          ...
          <div class="row">
            <div class="col-6 d-flex justify-content-end">
              <router-link
                :to="{
                  path: '/pl/TS/p_4',
                  query: { project_id: project_id || '', project_type: 4 },
                }"
              >
                <button
...
const Project_Data_P5 = reactive({
  assessmentMethods: {
...
const handleFileChange = (event) => {
  ...
  Project_Data_P5.projectImpact.file = validFiles.length > 0 ? validFiles[0] : null;
...
const submitFile = async () => {
  ...
  //console.log("Uploading file:", files.value[0]);
  //console.log("projectId:", project_id.value);
  //console.log("projectType:", project_type.value);
...
const getDataWhenProjectID = async () => {
  try {
    const response = await axios.post("http://localhost:5000/pl/get/p_5", {
    ...
    Project_Data_P5.assessmentMethods = project_data.assessmentMethods;
    Project_Data_P5.followUpMethods = project_data.followUpMethods;
    Project_Data_P5.followUpDuration = project_data.followUpDuration;
    Project_Data_P5.projectImpact = project_data.projectImpact;
...
const autoSave = debounce(async () => {
  console.log("Raw Project_Data_P5:", JSON.parse(JSON.stringify(Project_Data_P5)));
  try {
    
    const response = await axios.post("http://localhost:5000/pl/p_5/income/save", {
      project_id: project_id.value,
      project_type: project_type.value,
      project_user: user_id.value,
      project_data: Project_Data_P5,
    ...
    if (response.data.success) {
      ...
      router.replace({
        path: "/pl/TS/p_6",
        query: { project_id: project_id.value || "", project_type: 4 },
      });
      Toast.fire({
        icon: "success",
        iconColor: "green",
...
watch(
  Project_Data_P5,
  (newVal, oldVal) => {
    //console.log("Project_Data_P5 has changed:");
...
watch(
  ...
  (newVal) => {
    ...
    if (newVal.followUpDuration.startDate?.trim() === newVal.followUpDuration.endDate?.trim()) {
      //console.log("❌ followUpDuration.startDate is empty");
      isCanGo = false;
      return;
    }

    const startDate = new Date(newVal.followUpDuration.startDate);
    const endDate = new Date(newVal.followUpDuration.endDate);
    if (isNaN(startDate.getTime()) || isNaN(endDate.getTime())) {
        // หากรูปแบบวันที่ไม่ถูกต้อง
        console.error("Invalid Start Date or End Date format in followUpDuration.");
        Toast.fire({
          icon: "error",
          title: "รูปแบบวันที่ติดตามผลไม่ถูกต้อง",
        });
        isCanGo = false;
        return;
    }
    ...
    if (endDate < startDate) {
      Toast.fire({
        icon: "error",
        title: "วันที่สิ้นสุดการติดตามต้องไม่ก่อนวันที่เริ่มต้นการติดตาม",
      });
      isCanGo = false; // ปิดใช้งานปุ่ม "ถัดไป"
      return; // หยุดการทำงานของ watch นี้ทันที
    }
