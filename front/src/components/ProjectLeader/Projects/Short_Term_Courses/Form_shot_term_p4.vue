        ...
        <div class="d-flex justify-content-center">
          ...
          >
            ...
            <div class="p-2">
              <div class="row">
              <div class="mb-3">
                  <label class="fs-4 fw-light text-white " for="project_duration"><b>ระยะเวลาการดำเนินการ</b></label>
                    ...
                    <div class="col-6">
                      <div class="d-flex flex-column ">
                        <div>
                          ...
                          <div class=" mt-2">
                            <input type="date" class="form-control text-center fw-light text-muted beautiful-box" v-model="Project_Data_ST_P4.startDate">
                          </div>
                        </div>
                      ...
                      <div class="d-flex flex-column ">
                        <div>
                          ...
                          <div class="d-flex mt-2">
                            <input type="date" class="form-control text-center fw-light text-muted beautiful-box" v-model="Project_Data_ST_P4.endDate">
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="mb-3">
                  <label class="text-white" for="location">
                    ...
                    <span class="fw-light">
                      (ให้ระบุสถานที่จัดให้ชัดเจน เช่น ห้องประชุมของอาคาร ห้องประชุมของหน่วยงาน หรือ ชื่อสถานที่จัด)</span
                    >
                  </label>
                  <input
                    class="form-control mt-3 beautiful-box"
                    type="text"
                    v-model="Project_Data_ST_P4.location"
                ...
                <div class="mb-3 mt-2">
                  <label class="fw-light text-white" for="multipleSessions"
                    ...
                    <span>(ให้ระบุสถานที่ เเละ ระยะเวลาเริ่มดำเนินการ) ตัวอย่าง ห้อง E4A-507 (2-3 มิ.ย. 2568)</span></label
                  >

                  <div class="mt-3">
                    <div
                      v-for="(session, index) in Project_Data_ST_P4.multipleSessions"
                      :key="index"
                    >
                      <div
                        class="row mt-3"
                      ...
                      >
                        <div
                          :class="
                            index === 0 ? 'col-6' : hoveredIndex === index ? 'col-5' : 'col-6'
                          "
                        >
                          <input
                ...
                <div class="mb-3 mt-3">
                    ...
                    <div class="row row-cols-2 g-0 gy-3 justify-content-between">
                      <div class="col d-flex align-items-center">
                        <input
                          ...
                          v-model="Project_Data_ST_P4.targetGroups.student.checked"
                          type="checkbox"
                        />
                      ...
                      <div class="col d-flex align-items-center">
                        <input
                          class="form-check-input me-2 circle-input"
                          v-model="Project_Data_ST_P4.targetGroups.professional.checked"
                          type="checkbox"
                        />
                        <label
                      ...
                      <div class="col d-flex align-items-center">
                        <input
                          class="form-check-input me-2 circle-input"
                          v-model="Project_Data_ST_P4.targetGroups.teacher.checked"
                          type="checkbox"
                        />
                      ...
                      <div class="col d-flex align-items-center">
                        <input
                          class="form-check-input me-2 circle-input"
                          v-model="Project_Data_ST_P4.targetGroups.general.checked"
                          type="checkbox"
                        />
                      ...
                      <div class="col d-flex align-items-center">
                        <input
                          class="form-check-input me-2 circle-input"
                          v-model="Project_Data_ST_P4.targetGroups.government.checked"
                          type="checkbox"
                        />
                        <label class="form-check-label text-white fs-5 mx-2" for="comment"
                          >ข้าราชการ</label
                      ...
                      <div class="col d-flex align-items-center">
                        <input
                          class="form-check-input me-2 circle-input"
                          v-model="Project_Data_ST_P4.targetGroups.etc.checked"
                          type="checkbox"
                        />
                        <label class="form-check-label text-white fs-5 mx-2" for="comment"
                          >อื่น ๆ</label
                  ...
                  <div v-if="Project_Data_ST_P4.targetGroups.etc.checked" class="mb-3 mt-3">
                    <input
                      type="text"
                      class="form-control beautiful-box"
                      v-model="Project_Data_ST_P4.targetGroups.etc.value"
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    v-model="Project_Data_ST_P4.targetArea"
...
const Project_Data_ST_P4 = reactive({
  location: "", // required
  startDate: "", // required
  endDate: "", // required
  multipleSessions: [
...
const addMultipleSession = () => {
  if (Project_Data_ST_P4.multipleSessions.length >= multipleSessions_limits) {
    is_multipleSession_limit.value = true;
    return;
  }

  Project_Data_ST_P4.multipleSessions.push({
    session_id: Project_Data_ST_P4.multipleSessions.length + 1,
    location: "",
    date: "",
  });
...
const decrease_multipleSession = (index) => {
  if (Project_Data_ST_P4.multipleSessions.length > 1) {
    Project_Data_ST_P4.multipleSessions.splice(index, 1);

    Project_Data_ST_P4.multipleSessions.forEach((obj, i) => {
      obj.session_id = i + 1;
    });
...
const getDataWhenProjectID = async () => {
  try {
    const response = await axios.post("http://localhost:5000/pl/ST/get/p_4", {
    ...
    Project_Data_ST_P4.location = project_data.location;
    Project_Data_ST_P4.startDate = project_data.startDate;
    Project_Data_ST_P4.endDate = project_data.endDate;
    Project_Data_ST_P4.multipleSessions = project_data.multipleSessions;
    Project_Data_ST_P4.targetGroups = project_data.targetGroups;
    Project_Data_ST_P4.targetGroupDetails = project_data.targetGroupDetails;
    Project_Data_ST_P4.targetArea = project_data.targetArea;
...
const autoSave = debounce(async () => {
  // loading.value = true
  try {
    const response = await axios.post("http://localhost:5000/pl/p_4/shot_term/save", {
      project_id: project_id.value,
      project_type: project_type.value,
      project_user: user_id.value,
      project_data: Project_Data_ST_P4,
...
watch(
  Project_Data_ST_P4,
  (newVal, oldVal) => {
    //console.log("Project_Data_ST_P4 has changed:");
...
watch(
  Project_Data_ST_P4,
  (newVal) => {
    //console.log("--- Checking Project_Data_ST_P4---");
