...
const ST_Save_P2 = (data, callback) => {
    let { project_id, project_type, project_data, project_user, project_affiliation } = data;
    const projectData = JSON.stringify({
        //project_type: project_data.project_type ,
        academicServiceIssues: project_data.academicServiceIssues , 
        learning_outcome: project_data.learning_outcome,
        course_hours: project_data.course_hours,
        alignment_list: project_data.alignment_list,
        sloList: project_data.sloList,
        planList: project_data.planList,
