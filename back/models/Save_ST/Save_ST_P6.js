...
const ST_Save_P6 = (data, callback) => {
    let { project_id, project_type, project_data, project_user, project_affiliation } = data;
    //console.log('P6',data)
    const projectData = JSON.stringify({
        compensation: project_data.compensation, 
        foodAccommodation: project_data.foodAccommodation, 
        otherExpenses: project_data.otherExpenses, 
        totalFc: project_data.totalFc,
        totalVc: project_data.totalVc,
