...
//excel try by Aris
const GetDataforExcel = require('../models/Get/GetDataforExcel')
//
...
// Get Excel try by Aris
router.post('/get/dataforexcel', (req, res) => {
    GetDataforExcel(req.body, (err, result) => {
        if (err) {
...
router.post('/proposal/send', (req, res) => {
  const { project_id, project_type } = req.body;

  sendProposal({ project_id, project_type }, (err, result) => {
    if (err) {
